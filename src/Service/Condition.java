...
public class Condition {//입력 단어에 따라 표정 변화
    ...
    private static Vector<ImageIcon> faceImgList = new Vector<ImageIcon>();
    private static Vector<JLabel>faceLabelList = new Vector<JLabel>();
    //0:안좋음 1:무표정 2:좋음 3:매우좋음
    private static Vector<JLabel>conditinoTextList = new Vector<>();//상태 텍스트 리스트
