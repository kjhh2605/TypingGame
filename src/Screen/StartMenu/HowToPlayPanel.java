...
public class HowToPlayPanel extends JPanel {
    private ImageIcon img1 = new ImageIcon(getClass().getResource("/images/howToPlay/1.png"));
    private ImageIcon img2 = new ImageIcon(getClass().getResource("/images/howToPlay/2.png"));
