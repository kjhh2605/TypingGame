...
public class IntroPanel extends JPanel {
    private ImageIcon kanyeImg = new ImageIcon(getClass().getResource("/images/intro/yzy.png"));
    private JLabel kanye;
    private Image backgroundImage = new ImageIcon(getClass().getResource("/images/intro/인트로배경.png")).getImage();
